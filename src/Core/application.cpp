...
// 	{
// 		//               COORDINATES                  /     COLORS           //
// 		-0.5f, -0.5f * float(sqrt(3)) * 1 / 3, 0.0f, 0.5f, 0.5f, 0.5    f,	 // Lower left corner
...
// 	std::cout << " this is a new entity 1" << e1.id << std::endl;
// 	std::cout << " this is a new entity 2" << e2.id << std::endl;
// 	scene1.AddComponent<TransformComponent>(e1, TransformComponent{});
// 	auto &e1Transform = scene1.GetComponent<TransformComponent>(e1);
